 ...
 * @author asus
 */
public class BelajarLogin extends javax.swing.JFrame {

    /**
     * Creates new form BelajarLogin
     */
    public BelajarLogin() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BelajarLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BelajarLogin().setVisible(true);
            }
        });
    }
