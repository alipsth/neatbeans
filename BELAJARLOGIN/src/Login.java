...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        nm = new javax.swing.JEditorPane();
        ...
        jScrollPane2.setViewportView(nm);
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(pw, javax.swing.GroupLayout.DEFAULT_SIZE, 142, Short.MAX_VALUE)))
                        .addGap(92, 92, 92))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            ("SELECT * FROM framelogin WHERE username='"+nama+"'"+"AND password='"+password+"'");
            
            if(set.next()){
                if(pw.getText().equals(set.getString("Password"))){
                    JOptionPane.showMessageDialog(rootPane, "BERHASIL");
                    this.setVisible(false);
                    new mahasiswa().setVisible(true);
                }else {JOptionPane.showMessageDialog(rootPane, "Silahkan" + "Periksa kembali password anda");
    ...
    private javax.swing.JEditorPane nm;
